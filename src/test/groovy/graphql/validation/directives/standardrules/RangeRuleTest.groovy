...
class RangeRuleTest extends BaseDirectiveRuleTest {


    @Unroll
    def "range rule constraints"() {

        DirectiveValidationRule ruleUnderTest = new RangeRule()
        ...
        "field( arg : String @Range(max : 10) ) : ID"                    | Long.valueOf("12")    | "Range;path=/arg;val:12.0;\t"
        "field( arg : String @Range(max : 10) ) : ID"                    | Integer.valueOf("12") | "Range;path=/arg;val:12.0;\t"
        "field( arg : String @Range(max : 10) ) : ID"                    | Short.valueOf("12")   | "Range;path=/arg;val:12.0;\t"
    }
}